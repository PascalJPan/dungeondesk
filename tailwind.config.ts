    ...
    extend: {
      ...
      colors: {
        ...
        node: {
          ...
          cluster1: "hsl(var(--node-cluster-1))",
          cluster2: "hsl(var(--node-cluster-2))",
          cluster3: "hsl(var(--node-cluster-3))",
          cluster4: "hsl(var(--node-cluster-4))",
          cluster5: "hsl(var(--node-cluster-5))",
          cluster6: "hsl(var(--node-cluster-6))",
        },
        edge: {
